  ...
  @foreach($feature as $row)
    <div class="row">
      <div class="col-md-6 col-sm-6">
        ...
        <h4 class="bottom30">{{$row->address}}, {{$row->location}}, {{$row->city}}</h4>
        <p class="bottom30">{!! $row->description !!}</p>
        <div class="row">
          <div class="col-md-6 col-sm-6">
        ...
        <div class="property_meta">
          <span><i class="icon-select-an-objecto-tool"></i>{{$row->area}} sq ft</span> <span><i class="icon-bed"></i>{{$row->bedrooms}} Bedrooms</span> <span><i class="icon-safety-shower"></i>2 Bathrooms</span> <span><i class="icon-old-television"></i>TV Lounge</span> <span><i class="icon-garage"></i>{{$row->garage}} Garage</span> 
        </div>
        <a href="{{ url('Property/Details/'.$row->id) }}" class="uppercase btn-blue border_radius space30">view all detail</a>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="feature_main">
          <img src="{{ asset($row->image_four)}}" alt="featured" class="img-responsive">
          <div class="bottom clearfix">
            <span class="pull-left">For {{$row->property_status}}</span>
            <h4 class="pull-right">{{$row->price}} TK Per Month - <small>Family {{$row->property_type}}</small></h4>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      @foreach($property as $row)
        <div class="item feature_item">
          <div class="image"><a href="{{ url('Property/Details/'.$row->id) }}"> <img src="{{ asset($row->image_four)}}" alt="Featured Property"></a> 
      ...
      <div class="col-sm-8 margin_bottom">
        ...
        <div class="media news_media">
          <div class="media-left">
            ...
            <img class="media-object border_radius" src="{{ asset('public/frontend/images/news1.jpg')}}" alt="Latest news">
            </a>
          </div>
        ...
        <div class="media news_media">
          <div class="media-left">
            <a href="javascript:void(0)">
            <img class="media-object border_radius" src="{{ asset('public/frontend/images/news2.jpg')}}" alt="Latest news">
            </a>
          </div>
          <div class="media-body">
        ...
        <div class="media news_media">
          <div class="media-left">
            <a href="javascript:void(0)">
            <img class="media-object border_radius" src="{{ asset('public/frontend/images/news3.jpg')}}" alt="Latest news">
            </a>
          </div>
          <div class="media-body">
            <h3><a href="#.">Historic Town House</a></h3>
