...
class FrontController extends Controller
{
    ...
    public function PropertyDetails($id)
    {
    	...
    	return view('frontend.propertydetails',compact('details'));
    }
    ...
    public function PropertySearch(Request $request)
    {
        ...
        $property = DB::table('properties')
                ...
                ->orWhere('properties.property_type','LIKE', "%{$type}%")
                ->orWhere('properties.property_status','LIKE', "%{$status}%")
                ->orWhere('properties.bedrooms','LIKE', "%{$bedroom}%")
                ->orWhere('properties.bathrooms','LIKE', "%{$bathroom}%")
                ->paginate(20);
